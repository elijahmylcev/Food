...
window.addEventListener('DOMContentLoaded', () => {
  ...
  window.addEventListener('scroll', showModalByScroll); // Использование Class для карточек
  ...
  class MenuCard {
    constructor(src, alt, title, descr, price, parentSelector, ...classes) {
      ...
      this.transfer = 27; // можно сделать динамическим
  ...
  function getDynamicInformation(selector) {
    ...
    input.addEventListener('input', () => {
      // Проверка input на наличие негодных символов
